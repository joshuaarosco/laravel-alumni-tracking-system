...
@push('content')
	<div class="content sm-gutter">
		<div class="container-fluid padding-25 sm-padding-10">
			<h1>Im here @ backoffice dashboard</h1>
			{{-- <div class="row">
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="p-l-20">
														...
														<p class="small hint-text m-t-5"><span class="label font-montserrat m-r-5">60%</span>Higher</p>
													</div>
												</div>
												<div class="col-sm-6"></div>
											</div>
											<div class='widget-8-chart line-chart' data-line-color="black" data-point-color="warning" data-points="true" data-stroke-width="2">
												<svg></svg>
											</div>
										</div>
									</div>
						...
						<div class="col-lg-12 m-b-10">
							<div class="widget-9 card no-border bg-success no-margin widget-loader-bar">
								<div class="full-height d-flex flex-column">
									...
									<div class="p-l-20">
										<h3 class="no-margin p-b-5 text-white">$23,000</h3><a class="btn-circle-arrow text-white" href="#"><i class="pg-arrow_minimize"></i></a> <span class="small hint-text text-white">65% lower than last month</span>
									</div>
									<div class="mt-auto">
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="pull-left small">
												<span>WMHC</span> <span class=" text-success font-montserrat"><i class="fa fa-caret-up m-l-10"></i> 9%</span>
											</div>
											<div class="pull-left m-l-20 small">
												<span>HCRS</span> <span class=" text-danger font-montserrat"><i class="fa fa-caret-up m-l-10"></i> 21%</span>
											</div>
											<div class="clearfix"></div>
										</div>
									</div>
									<div class="p-t-10 full-width">
										<a class="btn-circle-arrow b-grey" href="#"><i class="pg-arrow_minimize text-danger"></i></a> <span class="hint-text small">Show more</span>
									</div>
								</div>
							</div>
						</div>
										...
										<div class="card-header pull-up top-right">
											<div class="card-controls">
												<ul>
													<li class="hidden-xlg">
														<div class="dropdown">
															<a aria-expanded="false" aria-haspopup="true" data-target="#" data-toggle="dropdown" href="#" role="button"><i class="card-icon card-icon-settings"></i></a>
									...
									<div class="row">
										<div class="col-sm-8">
											<div class="p-l-5">
												...
												<h2 class="pull-left m-l-50 m-t-5 m-b-5 text-danger"><span class="">448.97</span> <span class="text-danger fs-12">-318.24</span></h2>
												<div class="clearfix"></div>
												<div class="full-width">
													<ul class="list-inline">
														<li>
															<a class="font-montserrat text-master" href="#">1D</a>
														</li>
														<li class="active">
															<a class="font-montserrat bg-master-light text-master" href="#">5D</a>
														</li>
														<li>
															<a class="font-montserrat text-master" href="#">1M</a>
														</li>
														<li>
															<a class="font-montserrat text-master" href="#">1Y</a>
														</li>
													</ul>
												</div>
										...
										<div class="col-sm-4">
											<div class="widget-12-search">
												<p class="pull-left">Company <span class="bold">List</span></p><button class="btn btn-default btn-xs pull-right"><span class="bold">+</span></button>
												<div class="clearfix"></div><input class="form-control m-t-5" placeholder="Search list" type="text">
											</div>
											<div class="company-stat-boxes">
												<div class="company-stat-box m-t-15 active padding-20 bg-master-lightest" data-index="0">
													<div>
														<button class="close" data-dismiss="modal" type="button"><i class="pg-close fs-12"></i></button>
														<p class="company-name pull-left text-uppercase bold no-margin"><span class="fa fa-circle text-success fs-11"></span> AAPL</p><small class="hint-text m-l-10">Yahoo Inc.</small>
														<div class="clearfix"></div>
													</div>
													<div class="m-t-10">
														<p class="pull-left small hint-text no-margin p-t-5">9:42AM ET</p>
														<div class="pull-right">
															<p class="small hint-text no-margin inline">37.73</p><span class=" label label-important p-t-5 m-l-5 p-b-5 inline fs-12">+ 0.09</span>
														</div>
														<div class="clearfix"></div>
													</div>
												</div>
												<div class="company-stat-box m-t-15 padding-20 bg-master-lightest" data-index="1">
													<div>
														<button class="close" data-dismiss="modal" type="button"><i class="pg-close fs-12"></i></button>
														<p class="company-name pull-left text-uppercase bold no-margin"><span class="fa fa-circle text-primary fs-11"></span> YHOO</p><small class="hint-text m-l-10">Yahoo Inc.</small>
														<div class="clearfix"></div>
													</div>
													<div class="m-t-10">
														<p class="pull-left small hint-text no-margin p-t-5">9:42AM ET</p>
														<div class="pull-right">
															<p class="small hint-text no-margin inline">37.73</p><span class=" label label-success p-t-5 m-l-5 p-b-5 inline fs-12">+ 0.09</span>
														</div>
														<div class="clearfix"></div>
													</div>
												</div>
												<div class="company-stat-box m-t-15 padding-20 bg-master-lightest" data-index="2">
													<div>
														<button class="close" data-dismiss="modal" type="button"><i class="pg-close fs-12"></i></button>
														<p class="company-name pull-left text-uppercase bold no-margin"><span class="fa fa-circle text-complete fs-11"></span> GOOG</p><small class="hint-text m-l-10">Yahoo Inc.</small>
														<div class="clearfix"></div>
													</div>
													<div class="m-t-10">
														<p class="pull-left small hint-text no-margin p-t-5">9:42AM ET</p>
					...
					<div class="widget-15 card card-condensed no-margin no-border widget-loader-circle">
						<div class="card-header">
							<div class="card-controls">
								<ul>
									<li>
										<a class="card-collapse" data-toggle="collapse" href="#"><i class="card-icon card-icon-collapse"></i></a>
									</li>
									<li>
										<a class="card-refresh text-black" data-toggle="refresh" href="#"><i class="card-icon card-icon-refresh"></i></a>
									</li>
						...
						<div class="card-body no-padding">
							<ul class="nav nav-tabs nav-tabs-simple">
								<li class="nav-item">
									<a class="p-t-5 active" data-toggle="tab" href="#">APPL<br>
									22.23<br>
									<span class="text-success">+60.223%</span></a>
								</li>
								<li class="nav-item">
									<a class="p-t-5" data-toggle="tab" href="#">FB<br>
									45.97<br>
									<span class="text-danger">-06.56%</span></a>
								</li>
								<li class="nav-item">
									<a class="p-t-5" data-toggle="tab" href="#">GOOG<br>
									22.23<br>
									<span class="text-success">+60.223%</span></a>
								</li>
							</ul>
							...
							<div class="p-t-20 p-l-20 p-r-20 p-b-30">
								<div class="row">
									<div class="col-md-9">
										<p class="fs-16 text-black">Apple’s Motivation - Innovation<br>
										distinguishes between A leader and a follower.</p>
										<p class="small hint-text p-b-10">VIA Apple Store (Consumer and Education Individuals)<br>
										(800) MY-APPLE (800-692-7753)</p>
									</div>
								...
								<div class="col-sm-5 col-lg-4 col-xlg-3 col-sm-height col-top no-padding">
									...
									<div class="card-body">
										<ul class="nav nav-pills m-t-5 m-b-15" role="tablist">
											<li class="active">
												<a class="b-a b-grey text-master" data-toggle="tab" href="#tab1" role="tab">fb</a>
											</li>
											<li>
												<a class="b-a b-grey text-master" data-toggle="tab" href="#tab2" role="tab">js</a>
											</li>
											<li>
												<a class="b-a b-grey text-master" data-toggle="tab" href="#tab3" role="tab">sa</a>
											</li>
										</ul>
										<div class="tab-content">
											<div class="tab-pane active" id="tab1">
												...
												<p class="all-caps font-montserrat no-margin text-success">14,256</p><br>
												<p class="hint-text all-caps font-montserrat small no-margin">Today</p>
												<p class="all-caps font-montserrat no-margin text-warning">24</p><br>
									...
									<div class="bg-master-light p-l-20 p-r-20 p-t-10 p-b-10 pull-bottom full-width hidden-xs">
										<p class="no-margin"><a href="#"><i class="fa fa-arrow-circle-o-down text-success"></i></a> <span class="hint-text">Super secret options</span></p>
									</div>
								</div>
								<div class="col-sm-7 col-lg-8 col-xlg-9 col-sm-height col-top no-padding relative">
									<div class="bg-master-light widget-13-map"></div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-4 visible-lg hidden-xlg sm-m-b-10">
					<div class="widget-15-2 card no-margin no-border widget-loader-circle">
						...
						<ul class="nav nav-tabs nav-tabs-simple">
							<li>
								<a class="active" href="#widget-15-2-tab-1">APPL<br>
								22.23<br>
								<span class="text-success">+60.223%</span></a>
							</li>
							<li>
								<a href="#widget-15-2-tab-2">FB<br>
								45.97<br>
								<span class="text-danger">-06.56%</span></a>
							</li>
							<li>
								<a href="#widget-15-2-tab-3">GOOG<br>
								22.23<br>
								<span class="text-success">+60.223%</span></a>
							</li>
						</ul>
						...
						<div class="p-t-10 p-l-20 p-r-20 p-b-30">
							<div class="row">
								<div class="col-md-9">
									...
									<p class="small hint-text">VIA Apple Store (Consumer and Education Individuals)<br>
									(800) MY-APPLE (800-692-7753)</p>
								</div>
								<div class="col-md-3 text-right">
				...
				<div class="col-md-4 col-lg-3 col-xlg-3 m-b-10 visible-xlg">
					<div class="widget-16 card no-border no-margin widget-loader-circle">
						...
						<div class="relative no-overflow">
							<div class="widget-16-chart line-chart" data-line-color="success" data-point-color="white" data-points="true" data-stroke-width="2">
								<svg></svg>
							</div>
						</div>
						<div class="b-b b-t b-grey p-l-20 p-r-20 p-b-10 p-t-10">
							...
							<div class="pull-right">
								<input data-init-plugin="switchery" type="checkbox">
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="b-b b-grey p-l-20 p-r-20 p-b-10 p-t-10">
							...
							<div class="pull-right">
								<input checked="checked" data-init-plugin="switchery" type="checkbox">
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="p-l-20 p-r-20 p-t-10 p-b-10">
							<p class="pull-left no-margin hint-text">Super secret options</p><a class="pull-right" href="#"><i class="fa fa-arrow-circle-o-down text-success fs-16"></i></a>
							<div class="clearfix"></div>
						</div>
					</div>
				</div>
							...
							<div class="card no-border no-margin">
								<div class="padding-15">
									<div class="item-header clearfix">
										<div class="thumbnail-wrapper d32 circular"><img alt="" data-src="{{asset('assets/img/profiles/3.jpg')}}" data-src-retina="{{asset('assets/img/profiles/3x.jpg')}}" height="40" src="{{asset('assets/img/profiles/3x.jpg')}}" width="40"></div>
										<div class="inline m-l-10">
											<p class="no-margin"><strong>Anne Simons</strong></p>
											<p class="no-margin hint-text">Shared a link <span class="location semi-bold"><i class="fa fa-map-marker"></i> NY center</span></p>
										</div>
									</div>
								</div>
								<hr class="no-margin">
								...
								<div class="relative">
									...
									<div class="widget-19-post no-overflow"><img alt="Post" class="block center-margin relative" src="{{asset('assets/img/social-post-image.png')}}"></div>
								</div>
								<div class="padding-15">
									<div class="hint-text pull-left">
										few seconds ago
									</div>
									<ul class="list-inline pull-right no-margin">
										<li>
											<a class="text-master hint-text" href="#">5,345 <i class="fa fa-comment-o"></i></a>
										</li>
										<li>
											<a class="text-master hint-text" href="#">23K <i class="fa fa-heart-o"></i></a>
										</li>
									</ul>
									<div class="clearfix"></div>
								</div>
				...
				<div class="col-md-12 col-lg-8 col-xlg-6 md-m-t-10">
					<div class="widget-17 card no-border no-margin widget-loader-circle">
						<div class="card-header">
							<div class="card-title">
								<i class="pg-map"></i> California, USA <span class="caret"></span>
							</div>
							<div class="card-controls">
								<ul>
									<li class="">
									...
									<div class="col-sm-6">
										<div class="row m-t-20">
											...
											<div class="col-lg-7">
												...
												<div class="pull-right">
													<canvas class="clear-day" height="64" width="64"></canvas>
												</div>
											</div>
										</div>
										...
										<div class="row m-t-10 timeslot">
											<div class="col-2 p-t-10 text-center">
												...
												<canvas class="partly-cloudy-day" height="25" width="25"></canvas>
												<p class="text-danger bold">30°C</p>
											</div>
											<div class="col-2 p-t-10 text-center">
												<p class="small">14:00</p>
												<canvas class="cloudy" height="25" width="25"></canvas>
												<p class="text-danger bold">30°C</p>
											</div>
											<div class="col-2 p-t-10 text-center">
												<p class="small">14:30</p>
												<canvas class="rain" height="25" width="25"></canvas>
												<p class="text-danger bold">30°C</p>
											</div>
											<div class="col-2 p-t-10 text-center">
												<p class="small">15:00</p>
												<canvas class="sleet" height="25" width="25"></canvas>
												<p class="text-danger bold">30°C</p>
											</div>
											<div class="col-2 p-t-10 text-center">
												<p class="small">15:30</p>
												<canvas class="snow" height="25" width="25"></canvas>
												<p class="text-danger bold">30°C</p>
											</div>
											<div class="col-2 p-t-10 text-center">
												<p class="small">16:00</p>
												<canvas class="wind" height="25" width="25"></canvas>
												<p class="text-danger bold">30°C</p>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="forecast-day col-sm-6 text-center m-t-10">
												<div class="bg-master-lightest p-b-10 p-t-10">
													...
													<canvas class="rain" height="64" width="64"></canvas>
													<h5 class="text-danger">32°</h5>
													<p>Feels like <span class="bold">sunny</span></p>
													<p class="small">Wind <span class="bold p-l-20">11km/h</span></p>
