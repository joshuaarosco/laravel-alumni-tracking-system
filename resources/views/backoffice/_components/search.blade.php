<div class="overlay hide" data-pages="search">
	<div class="overlay-content has-results m-t-20">
		<div class="container-fluid">
			<h3><strong>Project X</strong></h3>
			{{-- <img alt="logo" class="overlay-brand" data-src="{{asset('assets/img/logo.png')}}" data-src-retina="{{asset('assets/img/logo_2x.png')}}" height="22" src="{{asset('assets/img/logo.png')}}" width="78">  --}}
			<a class="close-icon-light overlay-close text-black fs-16" href="#"><i class="pg-close"></i></a>
		</div>
		<div class="container-fluid">
